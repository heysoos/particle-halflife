...
# NOTE (2026-06-12): the _hash_to_partition tests that lived here were removed
# with the function itself — fission no longer partitions by hashing slot
# indices. Bond-cut fission's building blocks are covered in
# tests/test_graph.py and the fission tests in tests/test_chemistry.py.
